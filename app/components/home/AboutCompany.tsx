...
export default function AboutCompany({
  title = "О компании",
  paragraphs = [
    "В 2025 году в мебельной индустрии произошло знаменательное событие: производство мебельных фабрик MANNGROUP и MANINIMOBILI было перенесено из самого западного региона России — города Калининграда — в крупнейший город и столицу Узбекистана — Ташкент.Такое стратегическое решение было принято по нескольким причинам: выгодное географическое положение города Ташкент, связывающего Центральную Азию с Россией, эффективная логистика и возможность выхода на новые рынки.",
  ],
  ctaLabel = "Подробнее",
  ctaHref = "/about",
  images = [
