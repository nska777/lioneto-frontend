...
const PAGE_URL = `${SITE_URL}/mebel-v-tashkente`;

export const metadata: Metadata = {
  title: "Мебель в Ташкенте — премиальная мебель Lioneto",
  description:
    "Lioneto — мебель в Ташкенте для современных интерьеров. Спальни, кровати, шкафы и интерьерные коллекции для дома. Каталог мебели, адреса салонов и актуальные модели.",
  keywords: [
    "мебель в Ташкенте",
    "мебель Ташкент",
  ...
  openGraph: {
    title: "Мебель в Ташкенте — премиальная мебель Lioneto",
    description:
      "Мебель Lioneto в Ташкенте: спальни, кровати, шкафы и интерьерные коллекции для современного дома.",
    url: PAGE_URL,
    type: "website",
    locale: "ru_RU",
    siteName: "Lioneto",
  ...
  twitter: {
    ...
    title: "Мебель в Ташкенте — премиальная мебель Lioneto",
    description:
      "Мебель Lioneto в Ташкенте: спальни, кровати, шкафы и интерьерные коллекции.",
...
const pageJsonLd = {
  ...
  url: PAGE_URL,
  description:
    "Мебель в Ташкенте от Lioneto: спальни, кровати, шкафы и интерьерные коллекции для современного дома.",
  inLanguage: "ru",
};
...
export default function FurnitureInTashkentPage() {
  return (
    <main className="bg-white text-black">
      ...
      <div className="mx-auto w-full max-w-[1200px] px-4 py-8 md:py-12">
        <nav className="text-[12px] tracking-[0.18em] text-black/50">
          ...
          <span className="text-black/80">МЕБЕЛЬ В ТАШКЕНТЕ</span>
        </nav>
        ...
        <header className="mt-6 max-w-4xl md:mt-10">
          ...
          <p className="mt-5 text-[15px] leading-7 text-black/75 md:text-[18px] md:leading-8">
            Lioneto — мебель в Ташкенте для современных интерьеров. На сайте
            представлены спальни, кровати, шкафы и интерьерные коллекции для
            дома. Здесь можно посмотреть каталог мебели, открыть популярные
            коллекции и перейти к контактам салонов.
          </p>
        ...
        <section className="mt-12 max-w-5xl">
          <h2 className="text-[26px] font-semibold tracking-[-0.02em] md:text-[36px]">
            Каталог мебели Lioneto в Ташкенте
          </h2>

          <div className="mt-5 space-y-5 text-[15px] leading-7 text-black/75 md:text-[17px] md:leading-8">
            <p>
              Если вы ищете мебель в Ташкенте, важно выбрать не только красивый
              дизайн, но и качество исполнения, материалы и целостность
              коллекции. Lioneto предлагает интерьерные решения для спальни и
              жилых пространств, где важны стиль, пропорции и визуальная
              гармония.
            </p>
            <p>
              На сайте можно открыть каталог мебели, посмотреть актуальные
              товары, перейти к популярным коллекциям и узнать адреса салонов в
              Ташкенте. Эта страница подходит тем, кто ищет магазин мебели в
              Ташкенте, премиальную мебель и современные интерьерные решения.
            </p>
          </div>
        </section>
          ...
          <div className="mt-6 space-y-4">
            <div className="rounded-3xl border border-black/10 p-5">
              <h3 className="text-[18px] font-semibold">
                Где посмотреть мебель Lioneto в Ташкенте?
              </h3>
            ...
            <div className="rounded-3xl border border-black/10 p-5">
              ...
              <p className="mt-2 text-[15px] leading-7 text-black/70">
                ...
                SALVADOR и другие интерьерные решения Lioneto.
              </p>
            </div>

            <div className="rounded-3xl border border-black/10 p-5">
              <h3 className="text-[18px] font-semibold">
                Где найти магазин мебели Lioneto в Ташкенте?
              </h3>
              <p className="mt-2 text-[15px] leading-7 text-black/70">
