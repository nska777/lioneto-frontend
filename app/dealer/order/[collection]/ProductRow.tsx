          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:gap-4">
            <div className="flex items-start gap-3 sm:flex-1 sm:gap-4">
              <button
                ...
                className="relative block h-[64px] w-[64px] shrink-0 cursor-zoom-in overflow-hidden rounded-[12px] bg-[#f1f1ed] transition hover:opacity-90 sm:h-[72px] sm:w-[72px] sm:rounded-[14px]"
                aria-label={`Открыть изображение ${product.title}`}
              >
                <Image
                  src={product.image}
                  alt={product.title}
