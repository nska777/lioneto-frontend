...
export const MEGA_SLIDES: Record<MegaSlidesKey, string[]> = {
  ...
  "bedrooms:elizabeth": [
    "/slidermenu/bedrooms/elizabeth/01.jpg",
    "/slidermenu/bedrooms/elizabeth/02.jpg",
  ],
...
export const MEGA_PREVIEWS: Record<string, MegaPreview> = {
  ...
  [makeCollectionHref("elizabeth", "bedrooms")]: {
    ...
    main: "/slidermenu/bedrooms/elizabeth/01.jpg",
    a: "/slidermenu/bedrooms/elizabeth/02.jpg",
  },
